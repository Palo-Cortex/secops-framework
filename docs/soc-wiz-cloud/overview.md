...
| Pack | System | Source |
|---|---|---|
| `soc-wiz-cloud.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-wiz-cloud-v1.0.3/soc-wiz-cloud-v1.0.3.zip) |
