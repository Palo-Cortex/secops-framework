...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-idp.zip` | `no` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-idp-v1.1.0/soc-crowdstrike-idp-v1.1.0.zip) |
