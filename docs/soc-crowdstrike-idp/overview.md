...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-idp.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-idp-v1.0.0/soc-crowdstrike-idp-v1.0.0.zip) |
