...
- [NDR (check-point-ndr)](ndr-generic-alerts.md)
...
| Pack | System | Source |
|---|---|---|
| `soc-checkpoint-ndr.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-checkpoint-ndr-v1.0.4/soc-checkpoint-ndr-v1.0.4.zip) |
