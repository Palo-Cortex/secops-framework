# Soc Framework Abnormal Security — Overview
...
- [Email Protection (abnormal-security)](abnormal-email.md)
...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkAbnormalSecurity.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkAbnormalSecurity-v1.0.0/SocFrameworkAbnormalSecurity-v1.0.0.zip) |
