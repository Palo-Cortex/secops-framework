...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkAbnormalSecurity.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkAbnormalSecurity-v1.0.6/SocFrameworkAbnormalSecurity-v1.0.6.zip) |
