...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-falcon.zip` | `no` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-falcon-v2.2.0/soc-crowdstrike-falcon-v2.2.0.zip) |
