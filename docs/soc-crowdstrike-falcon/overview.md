...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-falcon.zip` | `no` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-falcon-v2.1.0/soc-crowdstrike-falcon-v2.1.0.zip) |
