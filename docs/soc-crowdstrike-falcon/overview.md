...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-falcon.zip` | `no` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-falcon-v2.0.2/soc-crowdstrike-falcon-v2.0.2.zip) |
