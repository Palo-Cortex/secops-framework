...
| Pack | System | Source |
|---|---|---|
| `soc-nozomi-guardian.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-nozomi-guardian-v1.1.0/soc-nozomi-guardian-v1.1.0.zip) |
