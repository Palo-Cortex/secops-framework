...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkTrendMicroVisionOne.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkTrendMicroVisionOne-v1.1.5/SocFrameworkTrendMicroVisionOne-v1.1.5.zip) |
