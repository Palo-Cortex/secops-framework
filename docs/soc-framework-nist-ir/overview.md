...
| Pack | System | Source |
|---|---|---|
| `soc-framework-nist-ir.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-framework-nist-ir-v1.10.1/soc-framework-nist-ir-v1.10.1.zip) |
