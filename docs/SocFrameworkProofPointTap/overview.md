...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkProofPointTap.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkProofPointTap-v1.5.8/SocFrameworkProofPointTap-v1.5.8.zip) |
