...
| Pack | System | Source |
|---|---|---|
| `soc-optimization-unified.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-optimization-unified-v3.20.3/soc-optimization-unified-v3.20.3.zip) |
