...
| Pack | System | Source |
|---|---|---|
| `SocFrameworkMicrosoftDefender.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/SocFrameworkMicrosoftDefender-v1.2.17/SocFrameworkMicrosoftDefender-v1.2.17.zip) |
