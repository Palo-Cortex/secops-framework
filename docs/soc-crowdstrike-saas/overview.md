...
| Pack | System | Source |
|---|---|---|
| `soc-crowdstrike-saas.zip` | `no` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-crowdstrike-saas-v1.1.2/soc-crowdstrike-saas-v1.1.2.zip) |
