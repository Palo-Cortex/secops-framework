...
| Pack | System | Source |
|---|---|---|
| `soc-microsoft-purview-dlp.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-microsoft-purview-dlp-v1.1.0/soc-microsoft-purview-dlp-v1.1.0.zip) |
