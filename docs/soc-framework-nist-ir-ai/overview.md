...
| Pack | System | Source |
|---|---|---|
| `soc-framework-nist-ir-ai.zip` | `yes` | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-framework-nist-ir-ai-v1.1.3/soc-framework-nist-ir-ai-v1.1.3.zip) |
