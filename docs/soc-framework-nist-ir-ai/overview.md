...
| Pack | System | Source |
|---|---|---|
| `soc-framework-nist-ir-ai.zip` |  | [release](https://github.com/Palo-Cortex/secops-framework/releases/download/soc-framework-nist-ir-ai-v1.4.1/soc-framework-nist-ir-ai-v1.4.1.zip) |
